...
install_fim () {
msg -ama "$(source trans -b pt:${id} "Instalacao NEW ADM ULTIMATE V2 Completa, Utilize os Comandos"|sed -e 's/[^a-z -]//ig')" && msg bar2
echo -e " menu / adm"
msg -bar2
}
ofus () {
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/rdrigodias/boltservers/master/trans &> /dev/null
msg -bar2
msg -ama "[ NEW - ULTIMATE 2018 V2 BY:@rdrigodias - SCRIPT ]"
[[ $1 = "" ]] && funcao_idioma || {
